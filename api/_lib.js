...
function authStatus(code) {
  if (['RESULT_SESSION_REQUIRED', 'RESULT_SESSION_NOT_ACTIVE', 'RESULT_SESSION_AUDIENCE_MISMATCH', 'IDENTITY_CREDENTIAL_NOT_ACTIVE', 'IDENTITY_ACCOUNT_NOT_ACTIVE', 'IDENTITY_PERSON_NOT_ACTIVE'].includes(code)) return 401;
  if (['RESULT_PERMISSION_DENIED', 'RESULT_CLASS_SCOPE_REQUIRED', 'RESULT_CLASS_SCOPE_DENIED', 'RESULT_SUBJECT_SCOPE_REQUIRED', 'RESULT_SUBJECT_SCOPE_DENIED', 'RESULT_ACCESS_NOT_GRANTED', 'RESULT_EMERGENCY_ADMIN_REQUIRED', 'RESULT_SCOPE_CONTEXT_REQUIRED', 'RESULT_ACADEMIC_CONTEXT_REQUIRED', 'RESULT_CLASS_NOT_ASSIGNED', 'RESULT_SUBJECT_NOT_ASSIGNED'].includes(code)) return 403;
  return 400;
}
